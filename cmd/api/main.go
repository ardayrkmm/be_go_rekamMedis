...
func main() {
	...
	recordUC := usecase.NewMedicalRecordUseCase(recordRepo, patientRepo, physioRepo, serviceRepo)
	appointmentUC := usecase.NewAppointmentUseCase(appointmentRepo, paymentRepo, serviceRepo)
	sessionUC := usecase.NewTherapySessionUseCase(sessionRepo, paymentRepo, serviceRepo)
	...
	http.NewMedicalRecordHandler(protectedAPI, recordUC)
	http.NewAppointmentHandler(protectedAPI, appointmentUC)
	http.NewTherapySessionHandler(protectedAPI, sessionUC)
